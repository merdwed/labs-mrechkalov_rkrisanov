    ...
    private final Object[][]   contents =
            {
                    ...
                    {"name", "emrin"},
                    {"price", "çmimi"},
                    {"location X", "vendndodhja X"},
                    {"location Y", "vendndodhja Y"},
                    {"location Z", "vendndodhja Z"},
                    {"coordinates X", "koordinon X"},
                    {"coordinates Y", "koordinon Y"},
                    {"type", "lloji"},
                    {"creator", "krijues"},
                    {"person", "personi"},
                    ...
                    {"host", "mikpritës"},
                    {"port", "port"},
                    {"check server", "kontrolloni serverin"},
                    {"add", "shtoni"},
                    {"account", "llogari"},
                    {"sign in", "Hyni"},
